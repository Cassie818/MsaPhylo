...
# read the random phylogenetic tree
t = Tree("./random_tree.newick", format=1)
t.name = str(len(t))
...
# sample sequence for the root node from the equilibrium distribution of amino acids
len_protein = 100
...
# simulate sequences for each node the evolution process is modelled as a continuous-time Markov chain.
...
with open("./simulated_msa.pkl", 'wb') as file_handle:
